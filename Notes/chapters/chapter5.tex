...
And let us use it to advance the function $q$ shown in \fig{fig:function-advect}

\begin{figure}
  \begin{center}
    \resizebox{\textwidth}{!}{\includegraphics{./figs/function_to_advect.pdf}}
  \end{center}
...
\beq
\frac{\partial q}{\partial t} = - u \frac{\partial q}{\partial x} +\frac{u\Delta x}{2}\frac{\partial^2 f}{\partial^2 x}
\eeq
...
\beq
f(x\pm \Delta x) = f(x) \pm \Delta x q^\prime(x) + \frac{\Delta
...
\beq
\frac{\partial q}{\partial x} \approx \frac{f(x+\Delta x) - f(x)}{\Delta x}
\eeq
