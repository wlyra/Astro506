...
The result is shown in \fig{fig:keff}. The spectrum is well-resolved
down to 2/3 of the Nyquist frequency for both derivatives. 


\begin{figure}
  \begin{center}
    \resizebox{\textwidth}{!}{\includegraphics{./figs/keff.png}}
  \end{center}
  \caption[]{Effective wavenumbers for the 1st and 2nd derivatives.}
  \label{fig:keff}
\end{figure}