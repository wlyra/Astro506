...
the expanding cloud of hot gas in the ISM. This evolution can be divided into diﬀerent
...
The shock wave created by the explosion moves outwards into the (more
or less homogeneous) interstellar gas at highly supersonic speed \figp{fig:sn1}. During the first phase of the SNR
...
\begin{figure}
  \begin{center}
    \resizebox{\textwidth}{!}{\includegraphics{./figs/sn1.png}}
  \end{center}
  \caption[]{The SN blast shocks against the ISM, sweeping it up and
    building a shell of hot, shocked material behind the shock front.}
  \label{fig:sn1}
\end{figure}
...
initial blast travels at $\approx 10^4$ km/s.


At this initial phase, as the pressure of the ISM is negligible, the
shock is not decellerated. The shock radius thus scales as

\beq
R_s(t) = u_e t. 
\eeq

The schematic structure of the SNR at this phase can be described as
follows \fig{fig:SNR}: behind
...
by a so-called contact discontinuity, i.e. a surface between two diﬀerent materials with
similar pressure and velocity but diﬀerent density
\fig{fig:contactdiscontinuity} (unlike a shock front where all three
...
\begin{figure}
  \begin{center}
    \resizebox{.43\textwidth}{!}{\includegraphics{./figs/SNR1.png}}
    \resizebox{.49\textwidth}{!}{\includegraphics{./figs/SNR2.png}}
  \end{center}
  \caption[]{Structure of an SNR. Forward shock: the initial blast
    propagates through the ISM. Behind the forward shock there is
    compressed interstellar gas, heated to millions of K.
    The SN ejecta is racing behind. When it meets the compressed
    interstellar gas, it generates a second shock. This shock is
    traveling outwards, but it trails the ejecta, so from the
    reference frame of the ejecta, it travels backwards. Thus it is called ``Reverse Shock''.
    The reverse shock heats up the SN ejecta also to millions of K.
    The shocked gas and ejecta are so hot they’re fully ionized, and
    cannot cool down efficiently. At this stage, the expansion is adiabatic.}
  \label{fig:snr}
\end{figure}
...
\begin{figure}
  \begin{center}
    \resizebox{\textwidth}{!}{\includegraphics{./figs/contactdiscontinuity.png}}
  \end{center}
  \caption[]{The ocean-air interface is an everyday example of contact
  discontinuity. At the discontinuity, the fluids have different
  densities, but equal pressure
  and normal velocity.}
  \label{fig:contactdiscontinuity}
\end{figure}
...
will start to aﬀect the expansion of the SNR. By definition, this is the end of the free
...
due to the eﬀects of the accumulated interstellar material. The second
...
fireball in its early moments \fig{fig:trinity}. Taylor then did the following
dimensional analysis.

\begin{figure}
  \begin{center}
    \resizebox{\textwidth}{!}{\includegraphics{./figs/Trinity.png}}
  \end{center}
  \caption[]{Footage of the Trinity explosion confirms the $r\sim t^{2/5}$
    power-law obtained by Taylor.}
  \label{fig:trinity}
\end{figure}
...
indeed a factor of order unity.
...
putting an end to the adiabatic expansion of the SNR. Due to the eﬃcient radiative cooling
...
this phase lasts until the velocity drops to subsonic and the shock is
not a shock anymore: the renmant mixes with the ISM. The phases of the
SNR are sketched in \fig{fig:phases}  and \fig{fig:powerlaws}. 


\begin{figure}
  \begin{center}
    \resizebox{\textwidth}{!}{\includegraphics{./figs/snrphases.png}}
  \end{center}
  \caption[]{The different phases of a supernova explosion.}
  \label{fig:phases}
\end{figure}
...
\begin{figure}
  \begin{center}
    \resizebox{\textwidth}{!}{\includegraphics{./figs/snrpowerlaws.png}}
  \end{center}
  \caption[]{Power-law dependency of the shell radius at different phases.}
  \label{fig:powerlaws}
\end{figure}
