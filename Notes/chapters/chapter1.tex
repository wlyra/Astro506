...
case $\v{Q}\otimes\v{u}$ has to be a 2nd rank tensor (see
Appendix~\ref{app:tensor} for a primer on tensors if the concept is unfamiliar). In index notation, $\v{Q}\otimes\v{u}$ is the
tensor $\vt{C}$ with components $C_{ij} = Q_i u_j$. It means the component $i$ of the
vector $\v{Q}$ flowing in the direction $j$.
